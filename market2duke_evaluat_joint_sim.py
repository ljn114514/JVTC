...
snapshot = 'snapshot/resnet50_market2duke_epoch00100.pth'

num_cam = 8
###########   DATASET   ###########
img_dir = dataset_path + 'DukeMTMC-reID/bounding_box_train_camstyle_merge/'
...
img_dir = dataset_path + 'DukeMTMC-reID/'
